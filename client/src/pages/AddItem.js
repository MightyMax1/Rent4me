				...
				<Container fluid={true} className={'border-right border-left px-5'} style={{ maxWidth: '430px' }}>
					...
					<FormGroup as={Row} size="sm" className="description">
						...
						<Form.Control
							...
							name="description"
							rows="3"
							placeholder=" הכנס תיאור מוצר עד 255 תווים"
							maxlength="255"
							required
						/>
					</FormGroup>
					...
					<Form.Row xl={12}>
						<FormGroup as={Col} md={6}>
							<FormLabel>מחיר לפי שעה:</FormLabel>
							<Form.Control
								size="sm"
								type="number"
								name="priceHour"
								placeholder='הכנס מחיר לפי שעה בש"ח'
								min="1"
								step="0.5"
								max="10000"
								required
						...
						<FormGroup as={Col} md={6}>
							<FormLabel>מחיר לפי יום:</FormLabel>
							<Form.Control
								size="sm"
								type="number"
								name="priceDay"
								placeholder='הכנס מחיר ליום בש"ח'
								min="1"
								step="0.5"
								max="10000"
								required
